...
prepareDataset <- function(factdir, annofile,
                annolist, ...){
    ...
    merged_Cells <- mergeCells(list = annolist, Cells = Cells)
    time3 <- Sys.time()
    ...
    print(paste0("time taken to run mergeCells() is: ",
    time3-time2))
...
mergeCells <- function(list, Cells){
