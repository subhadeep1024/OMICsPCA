...
analyse_variables <- function(name, Assay, choice, title = NULL,
    ...
    switch(choice,
        ...
        "2" = {
            ...
            print(eval(parse(text = paste0(name,"@PCA$", Assay,
            "$var$",var_type))))
        ...
        "3" = {
            ...
            tmp = eval(parse(text = paste0(name,"@PCA$",
            Assay,"$var$cor")))
        ...
        "6" = {
            ...
            variable <- value <- NULL
            factor = paste0(name,"@PCA$", Assay[1],"$eig")

            mydata <- as.data.frame(eval(parse(
            text = factor)))[,2, drop = FALSE]
            factornames <- Assay
