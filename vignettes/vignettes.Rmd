...
Gm12878 <- read.delim(
system.file("extdata/factors/H3k27ac/Gm12878.bed", package = "OMICsPCAdata"),
header=FALSE, sep = "\t")

names(Gm12878) <- c("chromosome", "start","end","intensity")

annotation <- read.delim(
system.file("extdata/annotation/TSS_groups.bed", package = "OMICsPCAdata"),
header=FALSE, sep = "\t")

names(annotation) <- c("chromosome", "start","end","TSS ID") 

TSS_list <- read.delim(
system.file("extdata/annotation/GENCODE_list", package = "OMICsPCAdata"),
header=FALSE, sep = "\t")
